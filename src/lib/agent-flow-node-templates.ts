...
export const agentFlowNodeTemplates: AgentFlowNodeTemplate[] = [
  ...
  },
  {
    ...
    subtitle: '上下文整理',
    category: '提示词',
    description: '把客户需求、项目约束和业务上下文整理成可交给智能体的提示词。',
  ...
  },
  {
    ...
    subtitle: 'LLM',
    category: '模型',
    description: '选择已经在模型管理里配置好的大模型，作为下游智能体的思考引擎。',
    inputs: [],
  ...
  },
  {
    ...
    subtitle: '知识与经验',
    category: '记忆',
    description: '把项目记忆、客户偏好、历史经验或软件操作方法交给下游智能体。',
  ...
  },
  {
    ...
    subtitle: '执行者',
    category: '智能体',
    description: '选择一个员工级智能体，持续完成规划、执行、验证和交付。',
